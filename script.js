...
// ============================================log box printing========================================================
var logPrintBtn = document.querySelector('.logStore');
logPrintBtn.addEventListener('click',()=>{
    if(clockStatus){
        const loginfo = document.querySelector('.logInfo');
        let timeStore = document.createElement("h3");
        timeStore.innerHTML = "<span class='material-symbols-outlined'>history</span>"+ currentLogTime;
        timeStore.classList.add('logs');
        loginfo.appendChild(timeStore);
    }
})
// ===========================================function for clear the displaylog area=======================================
function clearLogs(){
    var deleteLog = document.querySelector('.logs');
    while(deleteLog){
        deleteLog.parentElement.removeChild(deleteLog);
        deleteLog = document.querySelector('.logs');
    }
}
var clearAll = document.querySelector('.clearAll');//function invocation for log clear =====================================
clearAll.addEventListener('click',clearLogs);
// ============================================main countdown funcion =========================================================
 function countdown(){
    ...
    currentLogTime = (`  ${days} : ${hours%24} : ${minutes%60} : ${seconds%60}`);
...
// =========================================format the time if its 2 or less than 1 digits add zeros =====================================
...
// ================================================add event for input date & input button ================================================
